...
function Register()
{
  ...
  return(
    ...
    <main className="flex z-10 items-center justify-center pt-12 px-4 sm:px-6 lg:px-8">
  ...
  shadow-[inset_0_0_.5px_#ffffff80,inset_-1px_-1px_.5px_#ffffff85,1.2px_1.2px_1px_#0003,-1.2px_-1.2px_.4px_#0000002e] sm:p-10" 
        >
          ...
          <form className="space-y-6" onSubmit={handleSubmit} noValidate>
            ...
            {/* Username Input */}
            <div className="mb-3">
              <p className=" pl-1 font-mourand text-3xl">Username</p>
              ...
              <input
                ...
                required
                className="appearance-none rounded-lg relative block w-full px-2 py-2 border border-gray-300 dark:border-gray-700 placeholder-gray-500 text-black  focus:outline-none focus:ring-cyan-500 focus:border-black focus:z-10 sm:text-sm"
          ...
          <p className="mt-6 text-center font-mourand text-2xl text-black ">
            ...
            <a href="/login" className="text-2xl font-mourand text-cyan-900 hover:text-cyan-700">
              Login
            </a>
          </p>
        </div>
